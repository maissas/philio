  ...
  register() {
    ...
    this.http.post("https://api.cloudinary.com/v1_1/dptwusdqw/upload", formData)
      ...
      response => {
        ...
        this.data["imageProfilePath"] = (response as uploadResponse).secure_url.replace("///g", "&#x2f;");
        ...
        this.http.post("https://api.cloudinary.com/v1_1/dptwusdqw/upload", formData)
          .subscribe(
            response => {
              console.log("response");
              console.log((response as uploadResponse).secure_url);
              this.data["imageExtraitNaissancePath"] = (response as uploadResponse).secure_url.replace("///g", "&#x2f;");
